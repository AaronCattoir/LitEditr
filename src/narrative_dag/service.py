    ...
    def analyze_document(
        ...
        *,
        ...
        try:
            ...
            if on_progress:
                on_progress("start", {"genre": request.genre, "run_id": run_id})
            ...
            if on_progress:
                on_progress("complete", {"run_id": run_id})
            return AnalyzeDocumentResponse(run_id=run_id, report=report, success=True)
